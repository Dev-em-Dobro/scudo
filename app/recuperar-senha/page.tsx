            ...
            <div className="hidden lg:flex lg:w-[45%] xl:w-2/5 flex-col justify-between p-12 border-r border-border-dark relative overflow-hidden">
                ...
                <div className="relative space-y-3">
                    <h2 className="text-3xl font-bold text-white leading-snug">
                        Recuperação de acesso <span className="text-primary">segura</span>
                    </h2>
                    <p className="text-slate-300 text-sm leading-relaxed max-w-xs">
                        Enviamos um link temporário para seu e-mail. Ele expira automaticamente para proteger sua conta.
                    </p>
                </div>
