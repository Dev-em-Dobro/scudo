...
export const PLATFORM_INTRO_TUTORIAL: OnboardingTutorial = {
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'No card de aptidão você vê seu nível atual e quais skills priorizar para aumentar compatibilidade.',
      type: 'info',
      route: '/',
    ...
    {
      id: 'assessments-page',
      title: 'Teste suas skills',
      description: 'Use os testes para identificar lacunas e reforçar os temas que mais impactam sua evolução.',
      type: 'info',
      route: '/jobs',
      anchorId: 'nav-assessments',
    },
    {
      id: 'assessments-overview',
      title: 'Entenda seus gaps prioritários',
      description: 'No painel de skills você enxerga com clareza os pontos a evoluir antes das próximas candidaturas.',
      type: 'info',
      route: '/assessments',
      anchorId: 'assessments-overview',
    },
    {
      id: 'assessments-warning',
      title: 'Fique atento ao status dos assessments',
      description: 'Este aviso explica o momento do módulo e como aproveitar o painel de gaps enquanto os testes evoluem.',
      type: 'info',
      route: '/assessments',
      anchorId: 'assessments-warning',
    },
    {
      id: 'assessments-stats',
      title: 'Comece pelos indicadores principais',
      description: 'Use cobertura, skills demandadas e gaps prioritários para orientar seu plano de evolução.',
      type: 'info',
      route: '/assessments',
      anchorId: 'assessments-stats',
    },
    {
      id: 'assessments-ranking',
      title: 'Priorize as skills mais demandadas',
      description: 'O ranking mostra as competências com maior incidência nas vagas para orientar seu estudo.',
      type: 'info',
      route: '/assessments',
      anchorId: 'assessments-ranking',
    },
    {
      id: 'assessments-study-plan',
      ...
      type: 'info',
      route: '/assessments',
      anchorId: 'assessments-study-plan',
    },
    {
      id: 'market-radar',
      title: 'Acompanhe o radar de mercado',
      description: 'No Radar de Mercado você monitora tendências e ajusta seu foco com base na demanda real.',
      type: 'info',
      route: '/assessments',
    ...
    },
    {
      ...
      description: 'O radar mostra distribuição de vagas e fit, ajudando você a priorizar estudos com impacto no mercado.',
      type: 'info',
      route: '/analytics',
    ...
    },
    {
      ...
      description: 'Esses cards resumem volume de vagas, fit médio e sinais de aderência para seu perfil.',
      type: 'info',
      route: '/analytics',
    ...
    },
    {
      ...
      title: 'Cruze fit com modelo de trabalho',
