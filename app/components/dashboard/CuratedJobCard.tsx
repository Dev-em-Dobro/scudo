                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <button
                            ...
                            disabled={isApplying}
                            className="cursor-pointer px-5 py-2 bg-primary hover:bg-primary/90 active:scale-95 disabled:cursor-not-allowed disabled:opacity-70 text-white text-xs font-bold rounded-lg uppercase tracking-wide transition-all duration-150 shadow-sm shadow-primary/20"
                        >
